...
function updateEmo(lr) {
	...
	if (lr) {
		if (thingie.offsetLeft < maxl) {
			emo.innerHTML = "<img src='stickers/6.webp'>";
		}
		if (thingie.offsetLeft < maxl - 2 * step) {
			emo.innerHTML = "<img src='stickers/4.webp'>";
		}
		if (thingie.offsetLeft < maxl - 4 * step) {
			emo.innerHTML = "<img src='stickers/5.webp'>";
		}
		if (thingie.offsetLeft < maxl - 6 * step) {
			emo.innerHTML = "<img src='stickers/3.webp'>";
		}
		...
		if (thingie.offsetLeft >= maxl) {
			if (thingie.offsetLeft > mazeWidth * 0.6) {
				emo.innerHTML = "<img src='stickers/2.webp'>";
			} else {
				emo.innerHTML = "<img src='stickers/1.webp'>";
			}
		...
		if (thingie.offsetLeft > mazeWidth) {
			...
			home.innerHTML = "🫶";
			setTimeout(function() {
				alert("Shabaaashh, So I Now Present To Youuu The Final Surpriseee 🤌!");
